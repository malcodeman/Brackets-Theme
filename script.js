function openMenu() {
    "use strict";
    var nav = document.getElementById("nav"), nav_content = document.getElementById("nav_content"), menu = document.getElementById("menu"), header_wrapper = document.getElementById("header_wrapper"), main_content = document.getElementById("main_content"), nav_social = document.getElementById("nav_social");
